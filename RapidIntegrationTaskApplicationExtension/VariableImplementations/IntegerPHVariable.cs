...
{
    [Serializable]
    public class IntegerPHVariable : IIntegerVariable, IPlaceHolderVariable
    {
        private ITask _ownerTask;
        private IIntegerVariable _variable;

        public IntegerPHVariable(ITask ownerTask, string variableName, string parentVariableName)
        {
            ...
            {
                _variable = variable as IIntegerVariable;
            }
            else
            {
                throw new RapidIntegrationTaskApplicationException("Not IIntegerVariable");
            }
        }
